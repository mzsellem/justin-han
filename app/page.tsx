...
export default function Home() {
  ...
  return (
    <>
      <div className="flex">
          <div className="md:text-lg text-xs font-mono font-bold bg-bluesuit text-white h-screen flex flex-col justify-center items-center">
            <div className="flex flex-col space-y-8">
              <button onClick={() => scrollToSectionWithOffset(section1Ref, 65)} className="hover:text-treegreen p-2 m-2">Home</button>
              <button onClick={() => scrollToSectionWithOffset(section2Ref, 65)} className="hover:text-treegreen p-2 m-2">Bio</button>
              <button onClick={() => scrollToSectionWithOffset(section3Ref, 65)} className="hover:text-treegreen p-2 m-2">Media</button>
              <button onClick={() => scrollToSectionWithOffset(section4Ref, 65)} className="hover:text-treegreen p-2 m-2">Events</button>
              <button onClick={() => scrollToSectionWithOffset(section5Ref, 65)} className="hover:text-treegreen p-2 m-2">Contact</button>
            </div>
          </div>
